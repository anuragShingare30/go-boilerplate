...
import (
	...
	"github.com/anuragShingare30/go-boilerplate/internal/sqlerr"
)
...
// @dev function with return type echo.MiddlewareFunc are the actual middleware functions!!!
...
// @dev logs every single request that it's our application
...
// @dev Whenever panic occurs during req-res cycle, this will recover it and send 500(Internal server error) response instead of crashing the server
